...
| 📱MiXplorer           | 6.49.5           |                                                          |
| 📱MOVIES              | 1.1.5            |                                                          |
| 📱[MusicFree]         | 0.1.0-alpha.5    | 一个插件化、定制化、无广告的开源音乐播放器               |
...
| 📱八戒影视Pro         | 2.2.0            | 支持蓝光、全屏、倍速、投屏、缓存下载离线播放、弹幕等功能 |
| 📱比特舟Pro           | 1.2.3            | BT种子磁力搜索工具                                       |
| 📱表情包生成器        | 1.8.6            |                                                          |
| 📱布丁扫描            | 2.4.1.0          | 手机扫描工具，原`全能扫描官`APP                          |
| 📱[橙心视频]          | 1.2.5            | 原`V影视`APP                                             |
| 📱[嘀嘀动漫]          | 1.7.6            |                                                          |
| 📱第二空间            | 10.3.8           | 隐私保护工具                                             |
| 📱📺[电视家]           | 3.1.3/3.10.20    | 免费电视直播软件                                         |
...
| 📱[解析机器人]        | 1.0.2            | 支持P2P下载、磁力下载、资源嗅探和50多种平台去水印        |
| 📱[卡音]              | 4.0.5            | 一款拥有三个搜索引擎、支持无损下载歌曲的音乐软件         |
| 📱快找资源            | 1.0.0            |                                                          |
| 📱蓝云                | 1.2.10           | 蓝奏云的第三方客户端                                     |
| 📱练字大师            | 4.2.0            |                                                          |
| 📱流舟文件            | 1.5.7            |                                                          |
| 📱[洛雪音乐助手]      | 1.0.4            | 基于`React native`开发的音乐软件                         |
| 📱漫画驿站            | 2.3.4            | 内置上百福利源漫画软件                                   |
| 📱萌盒                | 4.1.0            |                                                          |
| 📱📺[秒看电视]         | 7.1.2            | 更高清、更流畅的直播软件                                 |
...
[魔音MORIN]: https://pan.quark.cn/s/7467f054104a '跳转下载页'
[奇妙搜索]: https://www.123pan.com/s/izDSVv-0JQWA '跳转下载页'
...
[下载工具箱]: https://dmla.lanzout.com/b05ocg2te '跳转下载页'
...
[宇宙工具箱]: https://bgg.lanzoui.com/b02cnadsj '跳转下载页'

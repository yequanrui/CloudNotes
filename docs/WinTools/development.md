...
| :--------------- | :------------------------------------ | :-------------------------------- |
| [aardio]         | 40.0.0                                | 桌面软件快速开发工具              |
| [DBeaver]        | [26.0.1][DBeaver-Down](Win/Mac/Linux) | 免费的通用数据库工具和SQL客户端   |
| [HBuilderX]      | 5.06(Win/Mac)                         | DCloud（数字天堂）的前端开发者IDE |
| [Inno Setup]     | [6.7.1][IS-Down]                      | 免费的安装包制作软件              |
| [Notepad--]      | [3.7.0.0][N--Down](Win/Mac/Linux)     | 轻量级文本编辑器                  |
| [Notepad3]       | [6.25.822.1][N3-Down](Win)            | 轻量级文本编辑器                  |
| [Notepad4]       | [26.3.0.6058][N4-Down](Win)           | 基于Scintilla的轻量级文本编辑器   |
...
| [Tabby]          | [1.0.230][Tabby-Down](Win/Mac/Linux)  | 基于TypeScript开发的终端模拟器    |
| [VSCode]         | [1.114.0][VSCode-Down](Win/Mac/Linux) | 微软的轻量级编辑器                |
| [微信开发者工具] | [2.01.2510290][WXD-Down]              | 简单高效地开发和调试微信小程序    |
...
[IS-Down]: https://jrsoftware.org/isdl.php '跳转下载页'

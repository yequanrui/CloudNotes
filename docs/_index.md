...
[![docsify-copy-code](https://img.shields.io/npm/v/docsify-copy-code?label=docsify-copy-code)](https://github.com/jperasmus/docsify-copy-code 'Go to homepage')
[![docsify-count](https://img.shields.io/npm/v/docsify-count?label=docsify-count)](https://github.com/827652549/docsify-count 'Go to homepage')
[![docsify-edit-on-github](https://img.shields.io/npm/v/docsify-edit-on-github?label=docsify-edit-on-github)](https://github.com/njleonzhang/docsify-edit-on-github 'Go to homepage')
[![docsify-footer](https://img.shields.io/npm/v/@alertbox/docsify-footer?label=docsify-footer)](https://github.com/alertbox/docsify-footer 'Go to homepage')
[![docsify-pagination](https://img.shields.io/npm/v/docsify-pagination?label=docsify-pagination)](https://github.com/imyelo/docsify-pagination 'Go to homepage')
[![docsify-scroll-to-top](https://img.shields.io/npm/v/docsify-scroll-to-top?label=docsify-scroll-to-top)](https://github.com/zhengxiangqi/docsify-scroll-to-top 'Go to homepage')
